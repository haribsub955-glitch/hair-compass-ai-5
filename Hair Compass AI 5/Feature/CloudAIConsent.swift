    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                Text("When on, Ask Wren, Deep analysis and the ingredient reader are answered by a secure cloud model (DeepSeek). Each request sends your question and your tracking summary — numbers, dates and notes — and, for the ingredient reader, the text read off a product label. Never your name, contact details or photos. When off, they run on-device where this iPhone supports it.")
                    .font(Clinical.caption(12))
                    .foregroundStyle(Clinical.secondary)
                    .fixedSize(horizontal: false, vertical: true)
